  ...
  const handlePrintKeteranganPoin = (siswaId: string) => {
    ...
    const docHtml = `
      ...
      <body>
        ...
        <div class="preamble">
          Yang bertanda tangan di bawah ini, Koordinator bimbingan konseling dan ketertiban siswa SMP Negeri 17 Tangerang Selatan menerangkan bahwasanya siswa tersebut di bawah ini telah tercatat dalam sistem poin pembinaan kedisiplinan dan pengurangan remisi:
        </div>
          ...
          <div style={{ width: '730px' }}>
            ...
            <div className="flex items-center justify-between pb-4 border-b-4 border-double border-slate-900 mb-6 text-center">
              ...
              <div className="flex-1 px-4">
                ...
                <h2 className="text-base font-bold text-slate-800">SMP NEGERI 17 TANGERANG SELATAN</h2>
                <p className="text-[10px] text-slate-500 italic mt-0.5">Jl. Kompleks Puspiptek No.17, Tangerang Selatan. Telp: (021) 7560555</p>
              </div>
